  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MoviesDetailsBloc>()
        ..add(GetMoviesRecommendationEvent(id: id))
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 4.0),
                                Text(
                                  '(${state.moviesDetailsModel?.voteAverage})',
                                  style: const TextStyle(
                                    fontSize: 1.0,
                                    fontWeight: FontWeight.w500,
                                    letterSpacing: 1.2,
                            ...
                            const SizedBox(width: 16.0),
                            Text(
                              _showDuration(state.moviesDetailsModel!.runtime!),
                              style: const TextStyle(
                        ...
                        const SizedBox(height: 8.0),
                        Text(
                          'Genres: ${_showGenres(state.moviesDetailsModel!.genres!)}',
                          style: const TextStyle(
                            color: Colors.white70,
                            fontSize: 12.0,
                            fontWeight: FontWeight.w500,
              ...
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  final recommendation =
                      state.moviesRecommendationModel?.results![index];
                  return FadeInUp(
                    from: 20,
                    duration: const Duration(milliseconds: 500),
                    child: ClipRRect(
                ...
                childCount: state.moviesRecommendationModel?.results?.length,
              ),
